...
//sum() 함수를 호출하여 return값을 sumResult 변수에 저장
const sumResult = sum();
const addResult = add();
...
/*
js에서는 선언만 된 변수와 null, "", 0, undefined가
지정된 변수는 "논리적 fasle로 인식"한다.
*/
let title1;
const title2 = null;
const title3 = "";
